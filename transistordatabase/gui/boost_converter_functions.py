...
:class:`~transistordatabase.topologies.converter_common.BoostConverter` base class.
Module-level functions are provided for backward compatibility with the GUI.
"""
from transistordatabase.topologies.converter_common import BoostConverter

_conv = BoostConverter()
